      ...
      body: Padding(
        ...
        children: [ Expanded(
          ...
          children: [ Expanded(
            flex: 1,
            child: Padding(
              padding: const EdgeInsets.all(5), child: InkWell(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              const Text("HEIGHT", style: TextStyle(
                color: Color(0xff626473), fontSize: 17,
              ...
              children: [ Expanded(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        calculateBMI.toStringAsFixed(2), style: const TextStyle(
                        color: Colors.white,
                        fontSize: 42,
                  ...
                  child: Padding(
                    ...
                    setState(() {
                      if (gender == "Male" || gender == "Female") {
                        if (age > 2) {
                          convertMeter = height /
                              100; // cm to meter calculateBMI = weight / (convertMeter * convertMeter); if(calculateBMI < 18.5)
                              {
